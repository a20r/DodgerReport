...
undirected, weighted graph, $(V, E)$, that represents the connectivity of
...
constraints for the roadmap are still satisfied. This algorithm is shown more
formally in Algo.~\ref{algo:diprm}.

\begin{algorithm}[ht]
    \caption{$\Function{TemporalRoadmap}(n, d, \delta t, s, p, O, A)$}
R   \algorithmicrequire{
